...
public class ReplicatedHashMap3<K extends Serializable, V extends Serializable> extends
    ...
    static {
        try {
            ...
            methods.put(PUT, ReplicatedHashMap3.class.getMethod("_put",
                                                               Serializable.class,
                                                               Serializable.class));
            methods.put(PUT_IF_ABSENT, ReplicatedHashMap3.class.getMethod("_putIfAbsent",
                                                                         Serializable.class,
                                                                         Serializable.class));
            methods.put(PUT_ALL, ReplicatedHashMap3.class.getMethod("_putAll", Map.class));
            methods.put(REMOVE, ReplicatedHashMap3.class.getMethod("_remove", Object.class));
            methods.put(REMOVE_IF_EQUALS, ReplicatedHashMap3.class.getMethod("_remove",
                                                                            Object.class,
                                                                            Object.class));
            methods.put(REPLACE_IF_EXISTS, ReplicatedHashMap3.class.getMethod("_replace",
                                                                             Serializable.class,
                                                                             Serializable.class));
            methods.put(REPLACE_IF_EQUALS, ReplicatedHashMap3.class.getMethod("_replace",
                                                                             Serializable.class,
                                                                             Serializable.class,
                                                                             Serializable.class));
            methods.put(CLEAR, ReplicatedHashMap3.class.getMethod("_clear"));
        }
     ...
     * start this map.
     */
    public ReplicatedHashMap3(Channel channel) {
        this(channel, false);
    }
     ...
     */
    public ReplicatedHashMap3(Channel channel,boolean persistent) {
     ...
     */
    public ReplicatedHashMap3(ConcurrentMap<K,V> map,Channel channel,boolean persistent) {
        if(channel == null)
    ...
    public V _put(K key, V value) {
        System.out.println("_put "+key.toString());
